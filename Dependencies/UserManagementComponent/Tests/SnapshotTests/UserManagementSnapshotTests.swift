...
@Test func testUIUserInitialization() async throws {
...
@Test func testUIUserCredentialsInitialization() async throws {
...
@Test func testUIUserProfileInitialization() async throws {
...
//@Test func testUIFailureUserrMan()  {
//    #expect(1 == 2)
//}
